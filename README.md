...
| **Split View** – grid / vertical / horizontal, up to 4 tabs, resizable gutters, unsplit one or all, drag a tab onto the page edge to split, "Split link in new tab", Alt+click a tab to split it with (or separate it from) the active tab                                                                                                                                                                                                                      | Done                |

...
# the TranslateDemo instrumentation selected, and finally collects the driver's measurements
...
grep -E "TranslateDemo|ZenTranslate|translate" "$DEMO_OUT/logcat.txt" | tail -n 300 > "$DEMO_OUT/translate-logcat.txt" || true

...
//        [--scenarios boot,restore,walkthrough,crash,clear-on-exit,scale,dark,mv3-worker,pip,split,features,recaptcha,downloads,notifications,default-browser]
...
// pair, clear-on-exit, the two mv3-worker legs, pip, the split pair, features and recaptcha run

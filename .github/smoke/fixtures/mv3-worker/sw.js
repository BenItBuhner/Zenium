...
// sandboxed renderers only: under --no-sandbox the line names the engine's own set (alarms, dom,
// extension, i18n, management, runtime, storage, tabs for this manifest).
const probe = {

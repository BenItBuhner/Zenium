...
/** The blank page or the new tab page: a tab that shows nothing of its own yet. */
export function isEmptyTabUrl(url: string): boolean {
  return !url || url === BLANK_URL || isNewTabUrl(url)
}

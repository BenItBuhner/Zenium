 ...
 * dialogs, since Chrome shows an embedded page's dialogs too. Extensions' user scripts
 * (`chrome.userScripts`) run in every frame as well, from a second synchronous ask.
 */

 ...
 * History, the bookmarks manager, Downloads, Licences, the task manager – each reading its
 * section and query from `tab.url`; a document page renders nothing here, its view shows it.
 * `data-surface="page"`

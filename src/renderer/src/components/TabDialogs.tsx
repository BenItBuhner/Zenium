 ...
 * the chrome and the print preview (Chrome's constrained window at the frame's size). The modal
 * ones render through the `FrameDialogHost` this mounts, so they centre

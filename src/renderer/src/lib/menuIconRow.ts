 ...
 * name a glyph is Chrome's row of icon buttons – Forward, the star, Download page, Page info,
 * Reload / Stop – rather than rows of text (`MenuSheet`). The core names the glyphs
 * (`src/core/menus.ts`); a group with one text row among them is rows, as any other.
 */

...
object FakeboxMorph {
    ...
    fun sheetFade(frames: List<Frame>, opening: Boolean): Verdict {
        ...
        val judged = unjudged.isEmpty()
        // How the fade was seen (a judged pass has a ramp): one frame caught part way, at its
        // opacity, or several over their span.
        fun seen(): String = if (ramp.size == 1) "one frame caught part way (at ${ramp.first().second.p()})"

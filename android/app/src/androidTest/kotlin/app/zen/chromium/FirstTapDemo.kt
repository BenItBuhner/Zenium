...
class FirstTapDemo : DemoHarness("firsttap-demo-state.json", "firsttap", "firsttap-demo") {
    ...
    override fun warmUp() {
        ...
        cardA = findByLabel(tabCard("Example Domain", "example.com")) ?: error("card A is not on screen")
        cardB = findByLabel(tabCard("Tea - Wikipedia")) ?: error("card B is not on screen")

...
object DownloadLogic {
    ...
    enum class InterruptReason(val wire: String, val message: String) {
        ...
        SERVER_NO_RANGE("server-no-range", "Couldn’t resume download"),
        ...
        FILE_ACCESS_DENIED("file-access-denied", "Couldn’t save file"),
        FILE_NO_SPACE("file-no-space", "Out of storage space"),
        FILE_NAME_TOO_LONG("file-name-too-long", "File name is too long"),
        FILE_TOO_LARGE("file-too-large", "File is too large"),
        FILE_VIRUS_INFECTED("file-virus-infected", "Virus detected"),
        FILE_BLOCKED("file-blocked", "Blocked by your organization"),
        FILE_SECURITY_CHECK_FAILED("file-security-check-failed", "Couldn’t check file"),
        FILE_SAME_AS_SOURCE("file-same-as-source", "File already exists"),

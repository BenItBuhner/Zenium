...
class CustomTabConfig(
    ...
    class ActionButton(val icon: Bitmap, val description: String, val intent: PendingIntent, val tint: Boolean)
    ...
    companion object {
        ...
        fun from(context: Context, intent: Intent): CustomTabConfig {
            ...
            return CustomTabConfig(
                ...
                actionButton = actionButton(extras),
        ...
        private fun actionButton(extras: Bundle): ActionButton? {
            val bundle = extras.getBundle(CustomTabsIntent.EXTRA_ACTION_BUTTON_BUNDLE) ?: return null
            ...
            return ActionButton(
                ...
                intent = intent,
                tint = extras.getBoolean(CustomTabsIntent.EXTRA_TINT_ACTION_BUTTON, false)
            )
        }
